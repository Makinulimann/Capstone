...
const getTingkatVariant = (tingkat: string) => {
    const variants = {
        Nasional: 'bg-purple-100 text-purple-800 border border-purple-200',
        Internasional: 'bg-green-100 text-green-800 border border-green-200',
        Regional: 'bg-blue-100 text-blue-800 border border-blue-200',
        Lokal: 'bg-orange-100 text-orange-800 border border-orange-200',
    };
        ...
        <Table class="shadow-sm text-xs">
            <TableHeader>
                <TableRow>
                    ...
                    <TableHead @click="handleSort('tingkat')" class="cursor-pointer transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 py-2 px-2">
                        <div class="flex items-center space-x-1 whitespace-nowrap">
                            <span>Tingkat</span>
                            <SortIcon column="tingkat" :current-sort="sort" :current-direction="direction" />
                        </div>
                    </TableHead>
            ...
            <TableBody>
                <TableRow v-for="pengajuan in props.data || []" :key="pengajuan.id" class="group">
                    ...
                    <TableCell class="py-2 px-2">
                        <span
                            ...
                            :class="getTingkatVariant(pengajuan.tingkat || 'N/A')"
                        >
